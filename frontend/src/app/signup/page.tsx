...
export default function SignupPage() {
  ...
  return (
    <div className="p-6 max-w-sm mx-auto space-y-4">
      ...
      <input className="border w-full p-2" placeholder="Username" onChange={e => setUsername(e.target.value)} />
      ...
      <button className="bg-black text-white w-full p-2" onClick={handleSignup}>
        Signup
      </button>
    </div>
  )
